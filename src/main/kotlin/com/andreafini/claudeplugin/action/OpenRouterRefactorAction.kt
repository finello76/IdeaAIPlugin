...
/** Pulsante 1 (OpenRouter): rifattorizza il codice selezionato, con indicazioni facoltative. */
class OpenRouterRefactorAction : AnAction() {

    override fun update(e: AnActionEvent) {
        // Visibile solo se c'è un editor E la API key di OpenRouter è configurata.
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        if (selected.isNullOrBlank()) {
            OpenRouterActionSupport.notifyError(project, "Seleziona prima un blocco di codice nell'editor.")
            return
        }

        val dialog = PromptDialog(
            project,
            dialogTitle = "OpenRouter: Refactor / Migliora",
        ...
        OpenRouterActionSupport.runRequest(
            project, editor, "OpenRouter: Refactor / Migliora",
