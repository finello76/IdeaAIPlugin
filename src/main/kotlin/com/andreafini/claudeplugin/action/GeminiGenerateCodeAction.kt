...
/** Pulsante 2 (Gemini): genera codice a partire da una richiesta e dal file aperto. */
class GeminiGenerateCodeAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val dialog = PromptDialog(
            project,
            dialogTitle = "Gemini: Genera codice",
        ...
        if (request.isBlank()) {
            GeminiActionSupport.notifyError(project, "Richiesta vuota.")
            return
        }
        ...
        GeminiActionSupport.runRequest(
            project, editor, "Gemini: Genera codice",
