...
/** Pulsante 1 (Gemini): rifattorizza il codice selezionato, con indicazioni facoltative. */
class GeminiRefactorAction : AnAction() {

    override fun update(e: AnActionEvent) {
        // Visibile solo se c'è un editor E la API key di Gemini è configurata.
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        if (selected.isNullOrBlank()) {
            GeminiActionSupport.notifyError(project, "Seleziona prima un blocco di codice nell'editor.")
            return
        }

        val dialog = PromptDialog(
            project,
            dialogTitle = "Gemini: Refactor / Migliora",
        ...
        GeminiActionSupport.runRequest(
            project, editor, "Gemini: Refactor / Migliora",
