...
/**
 * Pulsante 3 (OpenRouter): analizza il codice per individuare errori, bug e possibili
 ...
 */
class OpenRouterAnalyzeCodeAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        if (code.isBlank()) {
            OpenRouterActionSupport.notifyError(project, "Non c'è codice da analizzare.")
            return
        }
        ...
        OpenRouterActionSupport.runRequest(
            project, editor, "OpenRouter: Analizza codice",
            type = "Analizza",
