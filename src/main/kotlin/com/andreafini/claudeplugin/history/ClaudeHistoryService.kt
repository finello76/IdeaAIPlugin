...
/**
 * Cronologia delle interazioni con Claude, persistente per progetto
 * (file `.idea/claudeAssistantHistory.xml`).
 */
@State(name = "ClaudeHistory", storages = [Storage("claudeAssistantHistory.xml")])
class ClaudeHistoryService : PersistentStateComponent<ClaudeHistoryService.State> {
    ...
    companion object {
        ...
        fun getInstance(project: Project): ClaudeHistoryService =
            project.getService(ClaudeHistoryService::class.java)
    }
}
