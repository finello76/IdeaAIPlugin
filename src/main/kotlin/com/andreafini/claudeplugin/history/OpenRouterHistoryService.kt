...
/**
 * Cronologia delle interazioni con OpenRouter, persistente per progetto
 * (file `.idea/openRouterAssistantHistory.xml`). Parallela e indipendente da
 * [ClaudeHistoryService].
 */
@State(name = "OpenRouterHistory", storages = [Storage("openRouterAssistantHistory.xml")])
class OpenRouterHistoryService : PersistentStateComponent<OpenRouterHistoryService.State> {
    ...
    companion object {
        ...
        fun getInstance(project: Project): OpenRouterHistoryService =
            project.getService(OpenRouterHistoryService::class.java)
    }
}
